    ...
    public partial class Form11 : Form
    {
        ...
        private void button_kaydiBarkodaDonustur_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connect.Open(); // Bağlantı kapalıysa aç
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            comboBox_kimAldi_kimVerdi.Text = dataGridView1.Rows[i].Cells[6].Value.ToString();
            comboBox_kimdenAldiIceri_kimeVerdiDisari.Text = dataGridView1.Rows[i].Cells[7].Value.ToString();
        }
