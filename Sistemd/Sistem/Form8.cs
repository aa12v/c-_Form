...
namespace Sistem
{
    public partial class Form8 : Form
    {
        ...
        public Form8(string kullaniciRol)
        {
            InitializeComponent();
        ...
        private void Form8_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.Parameters.AddWithValue("@id", 7); // Verileri hangi ID'ye sahip kayıttan çekecekseniz ona göre ayarlayın.
        ...
        private void kARTBİLGİToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Form11 form11 = new Form11("form8");
            form11.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form10 form10 = new Form10("form8");
            form10.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form12 form12 = new Form12("form8");
            form12.Show();
            this.Hide();
        }
    }
