...
namespace Sistem
{
    public partial class Form3 : Form
    {
        ...
        public Form3(string kullaniciRol)
        {
            InitializeComponent();
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.Parameters.AddWithValue("@id", 2); // Verileri hangi ID'ye sahip kayıttan çekecekseniz ona göre ayarlayın.
        ...
        private void kARTBİLGİToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Form10 form10 = new Form10("form3");
            form10.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form12 form12 = new Form12("form3");
            form12.Show();
            this.Hide();
        }
