...
namespace Sistem
{
    ...
    public partial class Form12 : Form
    {
        ...
        public Form12(string kullaniciRol)
        {
            InitializeComponent();
        ...
        {
            // Personel Bilgi butonuna tıklandığında Form10'u açın ve bu formu gizleyin.
        ...
        {
            // Kullanıcı kimlik bilgisi örneği (bu kimlik bilgisini giriş yaparken alabilirsiniz):
            int kullaniciId = GetLoggedInUserId(); // GetLoggedInUserId() gerçek kullanıcı kimlik bilgisini alma işlemini simgeliyor.

            // Kullanıcının kendi formunu açma işlemi:
            FormKullanici formKullanici = new FormKullanici(kullaniciId); // Kullanıcı kimlik bilgisini kullanarak kendi formunu açın.
            formKullanici.Show(); // Kullanıcı formunu gösterin.
            this.Hide(); // Şu anki formu gizleyin veya kapatın.
        }
