...
namespace Sistem
{
    public partial class Form6 : Form
    {
        ...
        public Form6(string kullaniciRol)
        {
            InitializeComponent();
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.Parameters.AddWithValue("@id", 5); // Verileri hangi ID'ye sahip kayıttan çekecekseniz ona göre ayarlayın.
        ...
        private void kARTBİLGİToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Form11 form11 = new Form11("form6");
            form11.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form12 form12 = new Form12("form6");
            form12.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form10 form10 = new Form10("form6");
            form10.Show();
            this.Hide();
        }
    }
