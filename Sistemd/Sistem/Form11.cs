...
namespace Sistem
{
    public partial class Form11 : Form
    {
        ...
        public Form11(string kullaniciRol)
        {
            InitializeComponent();
        ...
        {
            // Kart butonuna tıkladığınızda Form11'i açın (zaten bu formunuz)
        }

        private void dIŞPERSONELDURUMToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // Dış butonuna tıkladığınızda Form12'yi açın
            Form12 form12 = new Form12(kullaniciRol);
            form12.Show();
            this.Hide(); // Mevcut formu gizleyin veya kapatın
        }

        private void pERSONELBİLGİToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // Elektronik butonuna tıkladığınızda Form10'u açın (örneğin)
        ...
        {
            // Ana Sayfa butonuna tıkladığınızda Form10'u açın
            Form10 form10 = new Form10(kullaniciRol);
            form10.Show();
            this.Hide(); // Mevcut formu gizleyin veya kapatın
        }
