...
namespace Sistem
{
    public partial class Form7 : Form
    {
        ...
        public Form7(string kullaniciRol)
        {
            InitializeComponent();
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.Parameters.AddWithValue("@id", 6); // Verileri hangi ID'ye sahip kayıttan çekecekseniz ona göre ayarlayın.
        ...
        private void kARTBİLGİToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Form11 form11 = new Form11("form7");
            form11.Show();
            this.Hide();
        }
        ...
        {
            // Ortasayfa seçildiğinde Form2'yi açın ve bu formu gizleyin.
            Form10 form10 = new Form10("form7");
            form10.Show();
            this.Hide();
        }
